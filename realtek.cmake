...
add_definitions (-DUSE_SKY_MODEL_NAME)
...
if (BUILD_XI1)
    ...
    #To enable dlna Mimetype only for Xi1 builds

    #for EU builds
    if (SKY_BUILD)
        message("Building for EU variant")
        add_definitions (-DSKY_BUILD)
    elseif (NOT SKY_BUILD)
...
if(SCREEN_CAPTURE)
    if(NOT DISABLE_SCREEN_CAPTURE)
        message("Yocto Realtek build: Building Realtek specific screen capturing")
        add_definitions (-DPLATFORM_SCREEN_CAPTURE)
    endif()
endif()

if(DEFINES,USE_XI1_MORE_DEFINITIONS)

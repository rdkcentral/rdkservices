...
private:
    ...
    std::condition_variable cv_;
        ...
        private:
			...
			uint32_t requestCurrentLatencyWrapper(const JsonObject& parameters, JsonObject& response);
			uint32_t reportCurrentLatencyWrapper(const JsonObject& parameters, JsonObject& response);
                        //End methods

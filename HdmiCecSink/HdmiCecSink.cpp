...
//=========================================== HdmiCecSinkProcessor =========================================
       ...
       void HdmiCecSinkProcessor::process (const SetOSDName &msg, const Header &header)
       {
	     ...
	     LOGINFO("updateStatus %d\n",updateStatus);
	     LOGINFO("update OSDNmae on request type %d", HdmiCecSink::_instance->deviceList[header.from.toInt()].m_isRequested);
       ...
       void HdmiCecSinkProcessor::process (const ReportPhysicalAddress &msg, const Header &header)
       {
	     ...
	     LOGINFO("update physicalAddress and deviceType on request type %d", HdmiCecSink::_instance->deviceList[header.from.toInt()].m_isRequested);

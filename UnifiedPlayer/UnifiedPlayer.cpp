...
namespace WPEFramework
{
    ...
    namespace Plugin
    {
        const string UnifiedPlayer::Initialize(PluginHost::IShell * /* service */)
        {
            return (string());
        }

        void UnifiedPlayer::Deinitialize(PluginHost::IShell * /* service */)
        {
                UnifiedPlayer::_instance = nullptr;
        }

        string UnifiedPlayer::Information() const
        {
            return (string());
        }

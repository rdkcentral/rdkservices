...
| [onBlocklistChanged](#event.onBlocklistChanged) | Triggers when the blocklist flag is modified |
...
<a name="event.onBlocklistChanged"></a>
## *onBlocklistChanged [<sup>event</sup>](#head.Notifications)*

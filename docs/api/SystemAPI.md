...
| :-------- | :-------- | :-------- |
| params | object |  |
| params.m_strTerritory | string |  old territory |
| params.territoryStr | string |  new territory |
| params.m_strRegion | string | old region |
| params.regionStr | string | new region |

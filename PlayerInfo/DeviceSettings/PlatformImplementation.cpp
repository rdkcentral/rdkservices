...
public:
    ...
    uint32_t Resolution(PlaybackResolution& res /* @out */) const override
    {
        ...
        if (currentResolution == "480i24") res = RESOLUTION_480I24;
        else if (currentResolution == "480i25") res = RESOLUTION_480I25;
        else if (currentResolution == "480i30") res = RESOLUTION_480I30;
        else if (currentResolution == "480i50") res = RESOLUTION_480I50;
        else if (currentResolution == "480i") res = RESOLUTION_480I;
        else if (currentResolution == "480p24") res = RESOLUTION_480P24;
        else if (currentResolution == "480p25") res = RESOLUTION_480P25;
        else if (currentResolution == "480p30") res = RESOLUTION_480P30;
        else if (currentResolution == "480p50") res = RESOLUTION_480P50;
        else if (currentResolution == "480p") res = RESOLUTION_480P;
        else if (currentResolution == "576i24") res = RESOLUTION_576I24;
        else if (currentResolution == "576i25") res = RESOLUTION_576I25;
        else if (currentResolution == "576i30") res = RESOLUTION_576I30;
        else if (currentResolution == "576i50") res = RESOLUTION_576I50;
        else if (currentResolution == "576i") res = RESOLUTION_576I;
        else if (currentResolution == "576p24") res = RESOLUTION_576P24;
        else if (currentResolution == "576p25") res = RESOLUTION_576P25;
        else if (currentResolution == "576p30") res = RESOLUTION_576P30;
        else if (currentResolution == "576p50") res = RESOLUTION_576P50;
        else if (currentResolution == "576p") res = RESOLUTION_576P;
        else if (currentResolution == "720p24") res = RESOLUTION_720P24;
        else if (currentResolution == "720p25") res = RESOLUTION_720P25;
        else if (currentResolution == "720p30") res = RESOLUTION_720P30;
        else if (currentResolution == "720p50") res = RESOLUTION_720P50;
        else if (currentResolution == "720p") res = RESOLUTION_720P;
        else if(currentResolution == "1080i24") res = RESOLUTION_1080I24;
        else if(currentResolution == "1080i25") res = RESOLUTION_1080I25;
        else if(currentResolution == "1080i30") res = RESOLUTION_1080I30;
        else if(currentResolution == "1080i50") res = RESOLUTION_1080I50;
        else if(currentResolution == "1080i") res = RESOLUTION_1080I;
        else if(currentResolution == "1080p24") res = RESOLUTION_1080P24;
        else if(currentResolution == "1080p25") res = RESOLUTION_1080P25;
        else if(currentResolution == "1080p30") res = RESOLUTION_1080P30;
        else if(currentResolution == "1080p50") res = RESOLUTION_1080P50;
        else if(currentResolution == "1080p60") res = RESOLUTION_1080P;
        else if(currentResolution == "2160p24") res = RESOLUTION_2160P24;
        else if(currentResolution == "2160p25") res = RESOLUTION_2160P25;
        else if(currentResolution == "2160p50") res = RESOLUTION_2160P50;

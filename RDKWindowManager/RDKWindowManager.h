...
namespace WPEFramework {
    ...
    namespace Plugin {
        ...
        public /*constants*/:
            ...
            //methods
            static const string RDK_WINDOW_MANAGER_METHOD_MOVE_TO_FRONT;
            static const string RDK_WINDOW_MANAGER_METHOD_MOVE_TO_BACK;
            static const string RDK_WINDOW_MANAGER_METHOD_MOVE_BEHIND;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_FOCUS;
            static const string RDK_WINDOW_MANAGER_METHOD_KILL;
            static const string RDK_WINDOW_MANAGER_METHOD_ADD_KEY_INTERCEPT;
            static const string RDK_WINDOW_MANAGER_METHOD_ADD_KEY_INTERCEPTS;
            static const string RDK_WINDOW_MANAGER_METHOD_REMOVE_KEY_INTERCEPT;
            static const string RDK_WINDOW_MANAGER_METHOD_ADD_KEY_LISTENER;
            static const string RDK_WINDOW_MANAGER_METHOD_REMOVE_KEY_LISTENER;
            static const string RDK_WINDOW_MANAGER_METHOD_ADD_KEY_METADATA_LISTENER;
            static const string RDK_WINDOW_MANAGER_METHOD_REMOVE_KEY_METADATA_LISTENER;
            static const string RDK_WINDOW_MANAGER_METHOD_INJECT_KEY;
            static const string RDK_WINDOW_MANAGER_METHOD_GENERATE_KEYS;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_SCREEN_RESOLUTION;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_SCREEN_RESOLUTION;
            static const string RDK_WINDOW_MANAGER_METHOD_CREATE_DISPLAY;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_CLIENTS;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_Z_ORDER;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_BOUNDS;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_BOUNDS;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_VISIBILITY;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_VISIBILITY;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_OPACITY;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_OPACITY;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_SCALE;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_SCALE;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_HOLE_PUNCH;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_HOLE_PUNCH;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_LOG_LEVEL;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_LOG_LEVEL;
            static const string RDK_WINDOW_MANAGER_METHOD_ENABLE_INACTIVITY_REPORTING;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_INACTIVITY_INTERVAL;
            static const string RDK_WINDOW_MANAGER_METHOD_RESET_INACTIVITY_TIME;
            static const string RDK_WINDOW_MANAGER_METHOD_SCALE_TO_FIT;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_KEYREPEATS_ENABLED;
            static const string RDK_WINDOW_MANAGER_METHOD_ENABLE_KEYREPEATS;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_TOPMOST;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_VIRTUAL_RESOLUTION;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_VIRTUAL_RESOLUTION;
            static const string RDK_WINDOW_MANAGER_METHOD_ENABLE_VIRTUAL_DISPLAY;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_VIRTUAL_DISPLAY_ENABLED;
            static const string RDK_WINDOW_MANAGER_METHOD_HIDE_ALL_CLIENTS;
            static const string RDK_WINDOW_MANAGER_METHOD_ENABLE_LOGS_FLUSHING;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_LOGS_FLUSHING_ENABLED;
            static const string RDK_WINDOW_MANAGER_METHOD_SHOW_CURSOR;
            static const string RDK_WINDOW_MANAGER_METHOD_HIDE_CURSOR;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_CURSOR_SIZE;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_CURSOR_SIZE;
            static const string RDK_WINDOW_MANAGER_METHOD_IGNORE_KEY_INPUTS;
            static const string RDK_WINDOW_MANAGER_METHOD_ENABLE_INPUT_EVENTS;
            static const string RDK_WINDOW_MANAGER_METHOD_KEY_REPEAT_CONFIG;
            static const string RDK_WINDOW_MANAGER_METHOD_GET_GRAPHICS_FRAME_RATE;
            static const string RDK_WINDOW_MANAGER_METHOD_SET_GRAPHICS_FRAME_RATE;

            // events
            static const string RDK_WINDOW_MANAGER_EVENT_ON_USER_INACTIVITY;
        ...
        private/*classes */:
            ...
            class RdkShellListener :  public RdkShell::RdkShellEventListener {
              ...
              public:
                RdkShellListener(RDKWindowManager* shell)
                    : mShell(*shell)
                {
                }

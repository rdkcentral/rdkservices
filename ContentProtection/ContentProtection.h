            ...
            ASSERT(_secManager->Subscribe<OnRemoveWatermarkParams>(
                       ...
                       [&](const OnRemoveWatermarkParams& params) {
                           auto watermark = _watermarkStorage
                                                .Get(params.GraphicId.Value());
                           if (!watermark.IsSet()) {
                               return; // No such watermark
                           }

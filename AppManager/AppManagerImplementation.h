...
namespace Plugin {
    ...
    public:
        ...
        protected:
             Job(AppManagerImplementation *helloWorldImplementation, EventNames event, JsonObject &params)
                : mAppManagerImplementation(helloWorldImplementation)
                , _event(event)
                , _params(params) {
       ...
       public:
            static Core::ProxyType<Core::IDispatch> Create(AppManagerImplementation *helloWorldImplementation, EventNames event, JsonObject params) {

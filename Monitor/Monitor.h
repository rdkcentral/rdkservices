...
#endif
#if (THUNDER_VERSION_MAJOR == 4 && THUNDER_VERSION_MINOR == 4 || THUNDER_VERSION_MAJOR == 4 && THUNDER_VERSION_MINOR == 2)
...
#elif (THUNDER_VERSION_MAJOR == 4 && THUNDER_VERSION_MINOR == 2)

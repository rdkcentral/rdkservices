...
## [2.0.0] - 2022-08-18
### Added
- Updated major API version to 2.0.0 due to an incompatible API name change
...
### Change
- Removed voiceSessionByText API. Instead, use voiceSessionRequest with type "ptt_transcription".

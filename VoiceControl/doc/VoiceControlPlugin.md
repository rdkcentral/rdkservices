...
org.rdk.VoiceControl plugin for Thunder framework.
...
## *sendVoiceMessage <sup>method</sup>*
...
| :-------- | :-------- | :-------- |
| params | object |  |
| params?.msgType | string | <sup>*(optional)*</sup>  |
| params?.trx | string | <sup>*(optional)*</sup>  |
| params?.created | number | <sup>*(optional)*</sup>  |
| params?.msgPayload | object | <sup>*(optional)*</sup>  |
...
| params?.language | string | <sup>*(optional)*</sup>  |
...
## *voiceSessionByText <sup>method</sup>*
...
## *onKeywordVerification <sup>event</sup>*
...
| params?.error?.reason | integer | <sup>*(optional)*</sup> The reason code the voice session was error: `1` - Session Terminated, `2` - Internal Error, `3` - Msg Send Failure, `4` - No Audio, `5` - Insufficient Audio, `6` - Connection Failure, `7` - Connection Timeout, `8` - Session Timeout (must be one of the following: *1*, *2*, *3*, *4*, *5*, *6*, *7*, *8*) |

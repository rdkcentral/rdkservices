	...
	void DisplaySettings::checkAtmosCapsEventHandler(const char *owner, IARM_EventId_t eventId, void *data, size_t len)
    {
        ...
        {   //sample servicemanager response:{"success":true,"supportedTvResolutions":["480i","480p","576i","720p","1080i","1080p"]}
            ...
            try
            {
                ...
                if(tvResolutions & dsTV_RESOLUTION_720p24)supportedTvResolutions.emplace_back("720p24");
                if(tvResolutions & dsTV_RESOLUTION_720p25)supportedTvResolutions.emplace_back("720p25");
                if(tvResolutions & dsTV_RESOLUTION_720p30)supportedTvResolutions.emplace_back("720p30");

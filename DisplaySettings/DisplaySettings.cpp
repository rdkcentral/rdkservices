...
namespace WPEFramework {
    ...
    namespace Plugin {
	    ...
	    Core::JSONRPC::Handler& DisplaySettings_v2 = JSONRPC::CreateHandler({ 2 }, *this);
	    ...
	    DisplaySettings_v2.Register<JsonObject, JsonObject>(_T("getVolumeLeveller"), &DisplaySettings::getVolumeLeveller2, this);
	    DisplaySettings_v2.Register<JsonObject, JsonObject>(_T("setVolumeLeveller"), &DisplaySettings::setVolumeLeveller2, this);
	    DisplaySettings_v2.Register<JsonObject, JsonObject>(_T("getSurroundVirtualizer"), &DisplaySettings::getSurroundVirtualizer2, this);
	    DisplaySettings_v2.Register<JsonObject, JsonObject>(_T("setSurroundVirtualizer"), &DisplaySettings::setSurroundVirtualizer2, this);

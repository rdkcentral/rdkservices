...
TEST_F(AVInputDsTest, getEdid2AllmSupport)
{
    ...
    EXPECT_EQ(string(""), handler.Invoke(connection, _T("getEdid2AllmSupport"), _T("{\"portId\": \"0\",\"allmSupport\":true}"), response));
...
TEST_F(AVInputDsTest, setEdid2AllmSupport)
{
    ...
    EXPECT_EQ(string(""), handler.Invoke(connection, _T("setEdid2AllmSupport"), _T("{\"portId\": \"0\",\"allmSupport\":true}"), response));

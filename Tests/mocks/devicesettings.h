...
public:
    ...
    virtual void selectPort(int8_t Port,bool audioMix = false, int videoPlane = 0,bool topMost = true) const = 0;
    virtual void scaleVideo(int32_t x, int32_t y, int32_t width, int32_t height) const = 0;
...
public:
    ...
    void selectPort(int8_t Port,bool audioMix = false,int videoPlane = 0,bool topMost = true) const
    {

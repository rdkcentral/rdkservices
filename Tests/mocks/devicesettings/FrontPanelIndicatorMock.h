...
public:
    ...
    MOCK_METHOD(void,setColor, (device::FrontPanelIndicator::Color newColor, const bool toPersist), (const, override));
    MOCK_METHOD(void,setColorInt, (uint32_t newColor, const bool toPersist), (const, override));

...
public:
    ...
    MOCK_METHOD(void,setColor, (device::FrontPanelIndicator::Color color, const bool toPersist), (const, override));
    MOCK_METHOD(void,setColorInt, (unsigned int color), (const, override));
    MOCK_METHOD(void,setColorInt, (unsigned int color, const bool toPersist), (const, override));

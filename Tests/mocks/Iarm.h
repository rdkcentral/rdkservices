...
extern IARM_Result_t IARM_Bus_Init(const char* name);
extern IARM_Result_t IARM_Bus_Connect();
extern IARM_Result_t IARM_Bus_IsConnected(const char* memberName, int* isRegistered);
extern IARM_Result_t IARM_Bus_RegisterEventHandler(const char* ownerName, IARM_EventId_t eventId, IARM_EventHandler_t handler);
extern IARM_Result_t IARM_Bus_UnRegisterEventHandler(const char* ownerName, IARM_EventId_t eventId);
extern IARM_Result_t IARM_Bus_Call(const char* ownerName, const char* methodName, void* arg, size_t argLen);
extern IARM_Result_t IARM_Bus_RegisterCall(const char* methodName, IARM_BusCall_t handler);

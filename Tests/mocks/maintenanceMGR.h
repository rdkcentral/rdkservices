 ...
 * You may obtain a copy of the License at
 ...
 typedef enum {
  MAINT_RFC_COMPLETE=0,
  MAINT_RFC_ERROR, // 1
  MAINT_LOGUPLOAD_COMPLETE, // 2
  MAINT_LOGUPLOAD_ERROR, // 3
  MAINT_PINGTELEMETRY_COMPLETE, // 4
  MAINT_PINGTELEMETRY_ERROR, // 5
  MAINT_FWDOWNLOAD_COMPLETE, // 6
  MAINT_FWDOWNLOAD_ERROR, // 7
  MAINT_FWDOWNLOAD_ABORTED, // 8
  MAINT_CRITICAL_UPDATE, // 9
  MAINT_REBOOT_REQUIRED, // 10
  MAINT_RFC_INPROGRESS, // 11
  MAINT_FWDOWNLOAD_INPROGRESS, // 13
  MAINT_LOGUPLOAD_INPROGRESS, // 14
  MAINT_STATUS_EMPTY // 15

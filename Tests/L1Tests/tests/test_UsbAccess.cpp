...
TEST_F(UsbAccessTest, getFileListFailure_when_setmntentNull)
{
    ...
    EXPECT_CALL(*p_wrapsImplMock, setmntent(::testing::_, ::testing::_))
...
TEST_F(UsbAccessTest, getFileListSuccess_withoutPath)
{
    ...
    bool res1 = (response.compare(string("{\"path\":\"\\/run\\/media\\/sda1\\/logs\",\"contents\":[{\"name\":\"..\",\"t\":\"d\"},{\"name\":\"PreviousLogs\",\"t\":\"d\"},{\"name\":\".\",\"t\":\"d\"}],\"success\":true}")) == 0);
    bool res2 = (response.compare(string("{\"path\":\"\\/run\\/media\\/sda1\\/logs\",\"contents\":[{\"name\":\".\",\"t\":\"d\"},{\"name\":\"..\",\"t\":\"d\"},{\"name\":\"PreviousLogs\",\"t\":\"d\"}],\"success\":true}")) == 0);
    EXPECT_EQ(res1 || res2, true);
}

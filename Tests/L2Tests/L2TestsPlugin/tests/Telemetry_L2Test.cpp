...
/********************************************************
************UPLOADREPORT USE CASE SCENARIO **************************
*******************************************************/
...
TEST_F(Telemetry_L2test,TelemetryReportupload)
{
    ...
    //params["telemetryUploadStatus"] = "UPLOAD_SUCCESS";
...
/********************************************************
************ PROFILESTATUS USE CASE SCENARIO **************************
*******************************************************/

TEST_F(Telemetry_L2test, Reportprofilestatus_test){
...
JSONRPC::LinkType<Core::JSON::IElement> jsonrpc(TELEMETRY_CALLSIGN, TELEMETRYL2TEST_CALLSIGN);
    ...
    //If status is neither STARTED nor COMPLETED.
...
/********************************************************
************ LOGAPPLICATION USE CASE SCENARIO **************************
*******************************************************/

TEST_F(Telemetry_L2test, logApplicationEvent_Test){
    JSONRPC::LinkType<Core::JSON::IElement> jsonrpc(TELEMETRY_CALLSIGN, TELEMETRYL2TEST_CALLSIGN);
    StrictMock<AsyncHandlerMock_Telemetry> async_handler;
    uint32_t status = Core::ERROR_GENERAL;
    JsonObject params;
    ...
    //If param don't have eventname and eventvalue.
    // params["eventName"] = "";
    // params["eventValue"] = "";
...
/********************************************************
************ ABORTREPORT USE CASE SCENARIO **************************
*******************************************************/

TEST_F(Telemetry_L2test, AbortReport){
...
/********************************************************
************ TELEMETRYMOCK USE CASE SCENARIO **************************
*******************************************************/

TEST_F(Telemetry_L2test, Telemetry_implementation_mock){

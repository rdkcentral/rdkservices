...
namespace WPEFramework {
    ...
    namespace Plugin {
        ...
        class LgiHdmiCec : public PluginHost::IPlugin, public PluginHost::JSONRPC , public FrameListener {
        private:
        ...
        public:
            ...
            virtual const string Initialize(PluginHost::IShell* service) override {return {};}

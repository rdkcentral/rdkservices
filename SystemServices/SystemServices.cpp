...
namespace WPEFramework {
	...
	const string SystemServices::FRIENDLY_ID = "friendly_id";
	    ...
	    m_ManufacturerDataModelNameValid = false;
             ...
             */
#ifdef DEBUG
            RegisterMethod(this, {1}, "sampleSystemServiceAPI", &SystemServices::sampleAPI, this);
#endif /* DEBUG */
            RegisterMethod(this, {1}, "getDeviceInfo", &SystemServices::getDeviceInfo, this);
#ifdef ENABLE_DEVICE_MANUFACTURER_INFO
            RegisterMethod(this, {1}, "getMfgSerialNumber", &SystemServices::getMfgSerialNumber, this);
#endif
            RegisterMethod(this, {1}, "reboot", &SystemServices::requestSystemReboot, this);
            RegisterMethod(this, {1}, "enableMoca", &SystemServices::requestEnableMoca, this);
            RegisterMethod(this, {1}, "queryMocaStatus", &SystemServices::queryMocaStatus,
                    this);
            RegisterMethod(this, {1}, "requestSystemUptime",
                    &SystemServices::requestSystemUptime, this);
            RegisterMethod(this, {1}, "getStateInfo", &SystemServices::getStateInfo, this);
#if defined(HAS_API_SYSTEM) && defined(HAS_API_POWERSTATE)
            RegisterMethod(this, {1}, "getPowerState", &SystemServices::getDevicePowerState,
                    this);
            RegisterMethod(this, {1}, "setPowerState", &SystemServices::setDevicePowerState,
                    this);
#endif /* HAS_API_SYSTEM && HAS_API_POWERSTATE */
            RegisterMethod(this, {1}, "setGzEnabled", &SystemServices::setGZEnabled, this);
            RegisterMethod(this, {1}, "isGzEnabled", &SystemServices::isGZEnabled, this);
            RegisterMethod(this, {1}, "hasRebootBeenRequested",
                    &SystemServices::isRebootRequested, this);
            RegisterMethod(this, {1}, "getMode", &SystemServices::getMode, this);
            RegisterMethod(this, {1}, "updateFirmware", &SystemServices::updateFirmware, this);
            RegisterMethod(this, {1}, "setMode", &SystemServices::setMode, this);
            RegisterMethod(this, {1}, "setBootLoaderPattern", &SystemServices::setBootLoaderPattern, this);
            RegisterMethod(this, {1}, "getFirmwareUpdateInfo",
                    &SystemServices::getFirmwareUpdateInfo, this);
            RegisterMethod(this, {1}, "setDeepSleepTimer", &SystemServices::setDeepSleepTimer,
                    this);
            RegisterMethod(this, {1}, "setPreferredStandbyMode",
                    &SystemServices::setPreferredStandbyMode, this);
            RegisterMethod(this, {1}, "getPreferredStandbyMode",
                    &SystemServices::getPreferredStandbyMode, this);
            RegisterMethod(this, {1}, "getAvailableStandbyModes",
                    &SystemServices::getAvailableStandbyModes, this);
            RegisterMethod(this, {1}, "getXconfParams", &SystemServices::getXconfParams, this);
            RegisterMethod(this, {1}, "getSerialNumber", &SystemServices::getSerialNumber,
                    this);
            RegisterMethod(this, {1}, "getDownloadedFirmwareInfo",
                    &SystemServices::getDownloadedFirmwareInfo, this);
            RegisterMethod(this, {1}, "getFirmwareDownloadPercent",
                    &SystemServices::getFirmwareDownloadPercent, this);
            RegisterMethod(this, {1}, "getFirmwareUpdateState",
                    &SystemServices::getFirmwareUpdateState, this);
            RegisterMethod(this, {1}, "getMacAddresses",&SystemServices::getMacAddresses, this);
            RegisterMethod(this, {1}, "setTimeZoneDST", &SystemServices::setTimeZoneDST, this);
            RegisterMethod(this, {1}, "getTimeZoneDST", &SystemServices::getTimeZoneDST, this);
            RegisterMethod(this, {1}, "getCoreTemperature", &SystemServices::getCoreTemperature,
                    this);
            RegisterMethod(this, {1}, "getCachedValue", &SystemServices::getCachedValue, this);
            RegisterMethod(this, {1}, "setCachedValue", &SystemServices::setCachedValue, this);
            RegisterMethod(this, {1}, "cacheContains", &SystemServices::cacheContains, this);
            RegisterMethod(this, {1}, "removeCacheKey", &SystemServices::removeCacheKey, this);
            RegisterMethod(this, {1}, "getPreviousRebootInfo",
                    &SystemServices::getPreviousRebootInfo, this);
            RegisterMethod(this, {1}, "getLastDeepSleepReason",
                    &SystemServices::getLastDeepSleepReason, this);
            RegisterMethod(this, {1}, "clearLastDeepSleepReason",
                    &SystemServices::clearLastDeepSleepReason, this);
#ifdef ENABLE_THERMAL_PROTECTION
            RegisterMethod(this, {1}, "getTemperatureThresholds",
                    &SystemServices::getTemperatureThresholds, this);
            RegisterMethod(this, {1}, "setTemperatureThresholds",
                    &SystemServices::setTemperatureThresholds, this);
	        RegisterMethod(this, {1}, "getOvertempGraceInterval",
                    &SystemServices::getOvertempGraceInterval, this);
            RegisterMethod(this, {1}, "setOvertempGraceInterval",
                    &SystemServices::setOvertempGraceInterval, this);
#endif /* ENABLE_THERMAL_PROTECTION */
            RegisterMethod(this, {1}, "getPreviousRebootInfo2",
                    &SystemServices::getPreviousRebootInfo2, this);
            RegisterMethod(this, {1}, "getPreviousRebootReason",
                    &SystemServices::getPreviousRebootReason, this);
            RegisterMethod(this, {1}, "getRFCConfig", &SystemServices::getRFCConfig, this);
            RegisterMethod(this, {1}, "getMilestones", &SystemServices::getMilestones, this);
            RegisterMethod(this, {1}, "enableXREConnectionRetention",
                    &SystemServices::enableXREConnectionRetention, this);
            RegisterMethod(this, {1}, "getSystemVersions", &SystemServices::getSystemVersions, this);
            RegisterMethod(this, {1}, "setNetworkStandbyMode", &SystemServices::setNetworkStandbyMode, this);
            RegisterMethod(this, {1}, "getNetworkStandbyMode", &SystemServices::getNetworkStandbyMode, this);
            RegisterMethod(this, {1}, "getPowerStateIsManagedByDevice", &SystemServices::getPowerStateIsManagedByDevice, this);
    	    RegisterMethod(this, {1}, "setTerritory", &SystemServices::setTerritory, this);
	        RegisterMethod(this, {1}, "getTerritory", &SystemServices::getTerritory, this);
            RegisterMethod(this, {1}, _T("getTimeZones"), &SystemServices::getTimeZones, this);
            RegisterMethod(this, {1}, "getLastFirmwareFailureReason", &SystemServices::getLastFirmwareFailureReason, this);
            RegisterMethod(this, {1}, "fireFirmwarePendingReboot", &SystemServices::fireFirmwarePendingReboot, this);
            RegisterMethod(this, {1}, "setFirmwareRebootDelay", &SystemServices::setFirmwareRebootDelay, this);
            RegisterMethod(this, {1}, "setFirmwareAutoReboot", &SystemServices::setFirmwareAutoReboot, this);
            RegisterMethod(this, {1}, "getPowerStateBeforeReboot", &SystemServices::getPowerStateBeforeReboot, this);
            RegisterMethod(this, {1}, "setOptOutTelemetry", &SystemServices::setOptOutTelemetry, this);
            RegisterMethod(this, {1}, "isOptOutTelemetry", &SystemServices::isOptOutTelemetry, this);
#ifdef ENABLE_SET_WAKEUP_SRC_CONFIG
            RegisterMethod(this, {1}, "setWakeupSrcConfiguration", &SystemServices::setWakeupSrcConfiguration, this);

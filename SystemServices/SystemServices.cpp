...
namespace WPEFramework {
	...
	const string SystemServices::FRIENDLY_ID = "friendly_id";
	    ...
	    m_ManufacturerDataModelNameValid = false;
             ...
             */
#ifdef DEBUG
            RegisterMethod(this, {1,2}, "sampleSystemServiceAPI", &SystemServices::sampleAPI, this);
#endif /* DEBUG */
            RegisterMethod(this, {1,2}, "getDeviceInfo", &SystemServices::getDeviceInfo, this);
#ifdef ENABLE_DEVICE_MANUFACTURER_INFO
            RegisterMethod(this, {1,2}, "getMfgSerialNumber", &SystemServices::getMfgSerialNumber, this);
#endif
            RegisterMethod(this, {1,2}, "reboot", &SystemServices::requestSystemReboot, this);
            RegisterMethod(this, {1,2}, "enableMoca", &SystemServices::requestEnableMoca, this);
            RegisterMethod(this, {1,2}, "queryMocaStatus", &SystemServices::queryMocaStatus,
                    this);
            RegisterMethod(this, {1,2}, "requestSystemUptime",
                    &SystemServices::requestSystemUptime, this);
            RegisterMethod(this, {1,2}, "getStateInfo", &SystemServices::getStateInfo, this);
#if defined(HAS_API_SYSTEM) && defined(HAS_API_POWERSTATE)
            RegisterMethod(this, {1,2}, "getPowerState", &SystemServices::getDevicePowerState,
                    this);
            RegisterMethod(this, {1,2}, "setPowerState", &SystemServices::setDevicePowerState,
                    this);
#endif /* HAS_API_SYSTEM && HAS_API_POWERSTATE */
            RegisterMethod(this, {1,2}, "setGzEnabled", &SystemServices::setGZEnabled, this);
            RegisterMethod(this, {1,2}, "isGzEnabled", &SystemServices::isGZEnabled, this);
            RegisterMethod(this, {1,2}, "hasRebootBeenRequested",
                    &SystemServices::isRebootRequested, this);
            RegisterMethod(this, {1,2}, "getMode", &SystemServices::getMode, this);
            RegisterMethod(this, {1,2}, "updateFirmware", &SystemServices::updateFirmware, this);
            RegisterMethod(this, {1,2}, "setMode", &SystemServices::setMode, this);
            RegisterMethod(this, {1,2}, "setBootLoaderPattern", &SystemServices::setBootLoaderPattern, this);
            RegisterMethod(this, {1,2}, "getFirmwareUpdateInfo",
                    &SystemServices::getFirmwareUpdateInfo, this);
            RegisterMethod(this, {1,2}, "setDeepSleepTimer", &SystemServices::setDeepSleepTimer,
                    this);
            RegisterMethod(this, {1,2}, "setPreferredStandbyMode",
                    &SystemServices::setPreferredStandbyMode, this);
            RegisterMethod(this, {1,2}, "getPreferredStandbyMode",
                    &SystemServices::getPreferredStandbyMode, this);
            RegisterMethod(this, {1,2}, "getAvailableStandbyModes",
                    &SystemServices::getAvailableStandbyModes, this);
            RegisterMethod(this, {1,2}, "getXconfParams", &SystemServices::getXconfParams, this);
            RegisterMethod(this, {1,2}, "getSerialNumber", &SystemServices::getSerialNumber,
                    this);
            RegisterMethod(this, {1,2}, "getDownloadedFirmwareInfo",
                    &SystemServices::getDownloadedFirmwareInfo, this);
            RegisterMethod(this, {1,2}, "getFirmwareDownloadPercent",
                    &SystemServices::getFirmwareDownloadPercent, this);
            RegisterMethod(this, {1,2}, "getFirmwareUpdateState",
                    &SystemServices::getFirmwareUpdateState, this);
            RegisterMethod(this, {1,2}, "getMacAddresses",&SystemServices::getMacAddresses, this);
            RegisterMethod(this, {1,2}, "setTimeZoneDST", &SystemServices::setTimeZoneDST, this);
            RegisterMethod(this, {1,2}, "getTimeZoneDST", &SystemServices::getTimeZoneDST, this);
            RegisterMethod(this, {1,2}, "getCoreTemperature", &SystemServices::getCoreTemperature,
                    this);
            RegisterMethod(this, {1,2}, "getCachedValue", &SystemServices::getCachedValue, this);
            RegisterMethod(this, {1,2}, "setCachedValue", &SystemServices::setCachedValue, this);
            RegisterMethod(this, {1,2}, "cacheContains", &SystemServices::cacheContains, this);
            RegisterMethod(this, {1,2}, "removeCacheKey", &SystemServices::removeCacheKey, this);
            RegisterMethod(this, {1,2}, "getPreviousRebootInfo",
                    &SystemServices::getPreviousRebootInfo, this);
            RegisterMethod(this, {1,2}, "getLastDeepSleepReason",
                    &SystemServices::getLastDeepSleepReason, this);
            RegisterMethod(this, {1,2}, "clearLastDeepSleepReason",
                    &SystemServices::clearLastDeepSleepReason, this);
#ifdef ENABLE_THERMAL_PROTECTION
            RegisterMethod(this, {1,2}, "getTemperatureThresholds",
                    &SystemServices::getTemperatureThresholds, this);
            RegisterMethod(this, {1,2}, "setTemperatureThresholds",
                    &SystemServices::setTemperatureThresholds, this);
	        RegisterMethod(this, {1,2}, "getOvertempGraceInterval",
                    &SystemServices::getOvertempGraceInterval, this);
            RegisterMethod(this, {1,2}, "setOvertempGraceInterval",
                    &SystemServices::setOvertempGraceInterval, this);
#endif /* ENABLE_THERMAL_PROTECTION */
            RegisterMethod(this, {1,2}, "getPreviousRebootInfo2",
                    &SystemServices::getPreviousRebootInfo2, this);
            RegisterMethod(this, {1,2}, "getPreviousRebootReason",
                    &SystemServices::getPreviousRebootReason, this);
            RegisterMethod(this, {1,2}, "getRFCConfig", &SystemServices::getRFCConfig, this);
            RegisterMethod(this, {1,2}, "getMilestones", &SystemServices::getMilestones, this);
            RegisterMethod(this, {1,2}, "enableXREConnectionRetention",
                    &SystemServices::enableXREConnectionRetention, this);
            RegisterMethod(this, {1,2}, "getSystemVersions", &SystemServices::getSystemVersions, this);
            RegisterMethod(this, {1,2}, "setNetworkStandbyMode", &SystemServices::setNetworkStandbyMode, this);
            RegisterMethod(this, {1,2}, "getNetworkStandbyMode", &SystemServices::getNetworkStandbyMode, this);
            RegisterMethod(this, {1,2}, "getPowerStateIsManagedByDevice", &SystemServices::getPowerStateIsManagedByDevice, this);
    	    RegisterMethod(this, {1,2}, "setTerritory", &SystemServices::setTerritory, this);
	        RegisterMethod(this, {1,2}, "getTerritory", &SystemServices::getTerritory, this);
            RegisterMethod(this, {1,2}, _T("getTimeZones"), &SystemServices::getTimeZones, this);
            RegisterMethod(this, {1,2}, "getLastFirmwareFailureReason", &SystemServices::getLastFirmwareFailureReason, this);
            RegisterMethod(this, {1,2}, "fireFirmwarePendingReboot", &SystemServices::fireFirmwarePendingReboot, this);
            RegisterMethod(this, {1,2}, "setFirmwareRebootDelay", &SystemServices::setFirmwareRebootDelay, this);
            RegisterMethod(this, {1,2}, "setFirmwareAutoReboot", &SystemServices::setFirmwareAutoReboot, this);
            RegisterMethod(this, {1,2}, "getPowerStateBeforeReboot", &SystemServices::getPowerStateBeforeReboot, this);
            RegisterMethod(this, {1,2}, "setOptOutTelemetry", &SystemServices::setOptOutTelemetry, this);
            RegisterMethod(this, {1,2}, "isOptOutTelemetry", &SystemServices::isOptOutTelemetry, this);
#ifdef ENABLE_SET_WAKEUP_SRC_CONFIG
            RegisterMethod(this, {1,2}, "setWakeupSrcConfiguration", &SystemServices::setWakeupSrcConfiguration, this);
#endif //ENABLE_SET_WAKEUP_SRC_CONFIG

#ifdef ENABLE_DEEP_SLEEP
            RegisterMethod(this, {1,2}, _T("getWakeupReason"),&SystemServices::getWakeupReason, this);
            RegisterMethod(this, {1,2}, _T("getLastWakeupKeyCode"), &SystemServices::getLastWakeupKeyCode, this);
#endif
            RegisterMethod(this, {1,2}, "uploadLogs", &SystemServices::uploadLogs, this);

#ifdef ENABLE_SYSTEM_GET_STORE_DEMO_LINK
            RegisterMethod(this, {1,2}, "getStoreDemoLink", &SystemServices::getStoreDemoLink, this);
#endif
            RegisterMethod(this, {1,2}, "deletePersistentPath", &SystemServices::deletePersistentPath, this);
            RegisterMethod<PlatformCaps>(this, {1,2}, "getPlatformConfiguration", &SystemServices::getPlatformConfiguration, this);
        }
                ...
                JsonObject& response)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONSYSTEMSAMPLEEVENT, parameters);
            returnResponse(true);
        }
#endif /* DEBUG */
        ...
        void SystemServices::onFirmwarePendingReboot(int seconds)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONFWPENDINGREBOOT, params);
        }
        ...
        void SystemServices::onSystemPowerStateChanged(string currentPowerState, string powerState)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONSYSTEMPOWERSTATECHANGED, params);
        }
        ...
        void SystemServices::onPwrMgrReboot(string requestedApp, string rebootReason)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONREBOOTREQUEST, params);
        }
        ...
        void SystemServices::onNetorkModeChanged(bool bNetworkStandbyMode)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONNETWORKSTANDBYMODECHANGED, params);
        }
	...
	bool SystemServices::getModelName(const string& parameter, JsonObject& response)
	{
        ...
        void SystemServices::onSystemModeChanged(string mode)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONSYSTEMMODECHANGED, params);
        }
                ...
                string firmwareVersion, string responseString)
        {
            ...
            LOGWARN("result: %s\n", jsonLog.c_str());
            NotifyEvent(this, {1,2}, EVT_ONFIRMWAREUPDATEINFORECEIVED, params);
        }
	...
	bool SystemServices::getSerialNumberTR069(JsonObject& response)
        ...
        void SystemServices::onFirmwareUpdateStateChange(int newState)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONFIRMWAREUPDATESTATECHANGED, params);
        }
        ...
        {
            JsonObject params;
            NotifyEvent(this, {1,2}, EVT_ON_SYSTEM_CLOCK_SET, params);
        }
                ...
                bool exceed, float temperature)
        {
            ...
            NotifyEvent(this, {1,2}, EVT_ONTEMPERATURETHRESHOLDCHANGED, params);
        }
	...
	void SystemServices::onTerritoryChanged(string oldTerritory, string newTerritory, string oldRegion, string newRegion)
	{
        ...
        NotifyEvent(this, {1,2}, EVT_ONTERRITORYCHANGED, params);
	}
	...
	void SystemServices::onTimeZoneDSTChanged(string oldTimeZone, string newTimeZone)
	{
        ...
        NotifyEvent(this, {1,2}, EVT_ONTIMEZONEDSTCHANGED, params);
	}

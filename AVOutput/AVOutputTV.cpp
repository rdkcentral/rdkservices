...
namespace Plugin {
    ...
    uint32_t AVOutputTV::getPrecisionDetail(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("PrecisionDetail",indexInfo,precisionDetail, PQ_PARAM_LDIM);
        if( err == 0 ) {
    ...
    uint32_t AVOutputTV::setPrecisionDetail(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("set","PrecisionDetail",inputInfo,PQ_PARAM_LDIM,precisionDetail);
		if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetPrecisionDetail(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","PrecisionDetail",inputInfo,PQ_PARAM_LDIM,precisionDetail);
        if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::getSDRGamma(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("SDRGamma",indexInfo,sdrGamma, PQ_PARAM_LDIM);
        if( err == 0 ) {
    ...
    uint32_t AVOutputTV::setSDRGamma(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("set","SDRGamma",inputInfo,PQ_PARAM_LDIM,sdrGamma);
        if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetSDRGamma(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","SDRGamma",inputInfo,PQ_PARAM_LDIM,sdrGamma);
        if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::getLocalContrastEnhancement(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("LocalContrastEnhancement",indexInfo,localContrastEnhancement, PQ_PARAM_LDIM);
        if( err == 0 ) {
    ...
    uint32_t AVOutputTV::setLocalContrastEnhancement(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("set","LocalContrastEnhancement",inputInfo,PQ_PARAM_LDIM,localContrastEnhancement);
		if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetLocalContrastEnhancement(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","LocalContrastEnhancement",inputInfo,PQ_PARAM_LDIM,localContrastEnhancement);
        if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::getMPEGNoiseReduction(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("MpegNoiseReduction",indexInfo,mpegNoiseReduction, PQ_PARAM_LDIM);
        if( err == 0 ) {
    ...
    uint32_t AVOutputTV::setMPEGNoiseReduction(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("set","MpegNoiseReduction",inputInfo,PQ_PARAM_LDIM,mpegNoiseReduction);
		if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetMPEGNoiseReduction(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","MpegNoiseReduction",inputInfo,PQ_PARAM_LDIM,mpegNoiseReduction);
        if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::getDigitalNoiseReduction(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("DigitalNoiseReduction",indexInfo,digitalNoiseReduction, PQ_PARAM_LDIM);
        if( err == 0 ) {
    ...
    uint32_t AVOutputTV::setDigitalNoiseReduction(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("set","DigitalNoiseReduction",inputInfo,PQ_PARAM_LDIM,digitalNoiseReduction);
		if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetDigitalNoiseReduction(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","DigitalNoiseReduction",inputInfo,PQ_PARAM_LDIM,digitalNoiseReduction);
        if(retval != 0 ) {
	...
	uint32_t AVOutputTV::getAISuperResolution(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("AISuperResolution",indexInfo,aiSuperResolution, PQ_PARAM_LDIM);
        if( err == 0 ) {
    ...
    uint32_t AVOutputTV::setAISuperResolution(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("set","AISuperResolution",inputInfo,PQ_PARAM_LDIM,aiSuperResolution);
		if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetAISuperResolution(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","AISuperResolution",inputInfo,PQ_PARAM_LDIM,aiSuperResolution);
        if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::getMEMC(const JsonObject& parameters, JsonObject& response) {
        ...
        int err = getLocalparam("MEMC",indexInfo,memc, PQ_PARAM_LDIM);
        if( err == 0 ) {
            response["memc"] = memc;
	...
	int retval= updateAVoutputTVParam("set","MEMC",inputInfo,PQ_PARAM_LDIM,memc);
	if(retval != 0 ) {
    ...
    uint32_t AVOutputTV::resetMEMC(const JsonObject& parameters, JsonObject& response) {
        ...
        int retval= updateAVoutputTVParam("reset","MEMC",inputInfo,PQ_PARAM_LDIM,memc);
        if(retval != 0 ) {

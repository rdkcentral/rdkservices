...
namespace WPEFramework {
    ...
    namespace Plugin {
        ...
        public /*constants*/:
            ...
            static const string RDKSHELL_METHOD_GET_DISPLAY_FRAME_RATE;
            static const string RDKSHELL_METHOD_SET_DISPLAY_FRAME_RATE;
        ...
        private/*registered methods (wrappers)*/:
            ...
            uint32_t getDisplayFrameRateWrapper(const JsonObject& parameters, JsonObject& response);
            uint32_t setDisplayFrameRateWrapper(const JsonObject& parameters, JsonObject& response);

...
#include <interfaces/json/JsonData_SecureStore.h>

namespace WPEFramework {
namespace Plugin {

    class SecureStore : public PluginHost::IPlugin, public PluginHost::JSONRPC {
    private:
        ...
        public:
            explicit Store2Notification(SecureStore& parent)
                : _parent(parent)
            {
            }
        ...
        public:
            ...
            {
                JsonData::SecureStore::SetValueParamsData params;
                params.Scope = JsonData::SecureStore::ScopeType(scope);
                params.Namespace = ns;
                params.Key = key;
                params.Value = value;
    ...
    public:
        ...
        BEGIN_INTERFACE_MAP(SecureStore)
    ...
    private:
        ...
        uint32_t endpoint_setValue(const JsonData::SecureStore::SetValueParamsData& params, JsonData::SecureStore::DeleteKeyResultInfo& response);
        uint32_t endpoint_getValue(const JsonData::SecureStore::DeleteKeyParamsInfo& params, JsonData::SecureStore::GetValueResultData& response);
        uint32_t endpoint_deleteKey(const JsonData::SecureStore::DeleteKeyParamsInfo& params, JsonData::SecureStore::DeleteKeyResultInfo& response);
        uint32_t endpoint_deleteNamespace(const JsonData::SecureStore::DeleteNamespaceParamsInfo& params, JsonData::SecureStore::DeleteKeyResultInfo& response);
        uint32_t endpoint_getKeys(const JsonData::SecureStore::DeleteNamespaceParamsInfo& params, JsonData::SecureStore::GetKeysResultData& response);
        uint32_t endpoint_getNamespaces(const JsonData::SecureStore::GetNamespacesParamsInfo& params, JsonData::SecureStore::GetNamespacesResultData& response);
        uint32_t endpoint_getStorageSize(const JsonData::SecureStore::GetNamespacesParamsInfo& params, JsonObject& response); // Deprecated
        uint32_t endpoint_getStorageSizes(const JsonData::SecureStore::GetNamespacesParamsInfo& params, JsonData::SecureStore::GetStorageSizesResultData& response);
        uint32_t endpoint_flushCache(JsonData::SecureStore::DeleteKeyResultInfo& response);
        uint32_t endpoint_getNamespaceStorageLimit(const JsonData::SecureStore::DeleteNamespaceParamsInfo& params, JsonData::SecureStore::GetNamespaceStorageLimitResultData& response);
        uint32_t endpoint_setNamespaceStorageLimit(const JsonData::SecureStore::SetNamespaceStorageLimitParamsData& params);

        void event_onValueChanged(const JsonData::SecureStore::SetValueParamsData& params)
        {

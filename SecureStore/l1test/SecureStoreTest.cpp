...
const auto kFile1 = "/tmp/securestore/l0test/securestoretest1";
const auto kFile2 = "/tmp/securestore/l0test/securestoretest2";
...
TEST_F(ASecureStore, MovesFileWhenInitializedWithNewAndPreviousPath)
{
